...
export default function Filter({ navigation }) {
  ...
  const [filterValue2, setfilterValue2] = useState<Vehicle>(queryStore.vehicleType)
        ...
        buttons={[
          {
            value: 'Distance',
            label: 'Distance',
            onPress: () => { setfilterValue1('Distance') },
          },
          {
            value: 'Price',
            label: 'Price',
            onPress: () => { setfilterValue1('Price') },
            disabled: (filterValue2 == 'Bicycle') ? true : false
          },
          {
            value: 'Availability',
            label: 'Availability',
            onPress: () => { setfilterValue1('Availability') },
            disabled: (filterValue2 == 'Bicycle') ? true : false
          },
        ]}
      />
      ...
      <SegmentedButtons style={styles.segmentedbuttons2}
        ...
        buttons={[
          ...
          },
          {
            value: 'Car',
            icon: 'car',
            onPress: () => { setfilterValue2('Car') },
          },
          {
            value: 'Motorcycle',
            icon: "motorbike",
            onPress: () => { setfilterValue2('Motorcycle') },
          },
          {
            value: 'Heavy Vehicle',
            icon: 'truck',
            onPress: () => { setfilterValue2('Heavy Vehicle') }
          },
        ]}
      />
