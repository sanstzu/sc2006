...
initializeConnection()
  .then(() => {
    ...
    updateAvailability();
    setInterval(updateAvailability, 1000 * 10); // every 30 seconds

    updateHDBPrice();
    setInterval(updateHDBPrice, 1000 * 60 * 60 * 24); // every 24 hours

    updateURAPrice();
    setInterval(updateURAPrice, 1000 * 60 * 60 * 24); // every 24 hours
